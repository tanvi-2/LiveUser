...
const userSchema = new mongoose.Schema({
  ...
  address: {
    street: {
      ...
      validate: {
        ...
        message:
          "Street must contain at least one alphabetic character and may include numbers, spaces, commas, periods, and hyphens.",
      },
    },
    city: {
      type: String,
  ...
  loginId: {
    ...
    validate: {
      ...
      message:
        "Use 8 alphanumeric characters, including at least one letter and one number.",
    },
  },
  password: {
    type: String,
...
// Ensure unique indexes for emailId
